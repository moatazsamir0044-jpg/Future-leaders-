...
export function NewPayrollButton({ sites, month, year }: { sites: Site[]; month: number; year: number }) {
  ...
  return (
    <>
      ...
      <Modal open={open} onClose={() => setOpen(false)} title="New Payroll Sheet" size="sm">
        <div className="space-y-4">
          <div>
            ...
            <select
              ...
              className="w-full h-9 rounded-lg border border-gray-300 bg-white px-3 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
